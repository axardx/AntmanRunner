...
void  Ground::SpawnGround( cocos2d::Layer *layer )
{
    ...
    */
	...
	if (ground2->getPositionX() <= origin.x - ground1->getContentSize().width * 0.5)
		ground2->setPosition(Point(ground1->getContentSize().width * 2.5 - GROUND_SPEED, origin.y + 10));
	else
		ground2->setPosition(Point(ground2->getPositionX() - GROUND_SPEED, origin.y + 10));
